...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        static class ShaderConstants
        {
            ...
            //AMD_FSR
            //EASU
            public static readonly int _RenderViewportSize = Shader.PropertyToID("_RenderViewportSize");
            public static readonly int _ContainerTextureSize = Shader.PropertyToID("_ContainerTextureSize");
            public static readonly int _UpscaledViewportSzie = Shader.PropertyToID("_UpscaledViewportSzie");
            public static readonly int _EASUConsts = Shader.PropertyToID("_EASUConsts");

            //RCAS
            public static readonly int _RCASConsts = Shader.PropertyToID("_RCASConsts");
